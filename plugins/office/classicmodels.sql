...
--
-- Host: localhost
-- Generation Time: Feb 15, 2015 at 03:18 PM
...
INSERT INTO `customers` (`customerNumber`, `name`, `contactLastName`, `contactFirstName`, `phone`, `address`, `addressLine2`, `city`, `state`, `postalCode`, `country`, `salesRepEmployeeNumber`, `creditLimit`) VALUES
...
(8659, 'sdf', '', '', '', '', NULL, '', '', '', '', NULL, NULL),
(8572, 'sdfsdf', '', '', '', '', NULL, '', '', '', '', NULL, NULL),
...
ALTER TABLE `customers`
 ADD PRIMARY KEY (`name`), ADD UNIQUE KEY `customerNumber` (`customerNumber`), ADD KEY `salesRepEmployeeNumber` (`salesRepEmployeeNumber`);

--
-- Indexes for table `employees`
--
ALTER TABLE `employees`
 ADD PRIMARY KEY (`employeeNumber`), ADD KEY `reportsTo` (`reportsTo`), ADD KEY `officeCode` (`officeCode`);
...
ALTER TABLE `orderdetails`
 ADD PRIMARY KEY (`orderNumber`,`productCode`), ADD KEY `productCode` (`productCode`);
