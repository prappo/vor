...
<div class="col-lg-6 col-sm-6">
  <h3 style="margin:10px 10px 20px 15px; color:#818da1; font-weight:200;"><i class="fa fa-arrow-circle-right"></i> Class Routine</h3>
</div>
...
if(is_admin()) {
  ...
  if(isset($_POST['add_routine'])) {
    ...
    $success = db_insert('scl_class_routine', $fields);
  ...
  if(isset($_POST['edit_class_routine'])) {
    if(empty($_POST['class']) || empty($_POST['subject']) || empty($_POST['day']) || empty($_POST['start']) || empty($_POST['end'])) {
      echo '<script>routine_empty();</script>';
      echo "<meta http-equiv='refresh' content='1;url='>";
      exit();
    ...
    $success = db_update('scl_class_routine', $fields, $where);
  ...
  if(isset($_GET['delete_routine']) && !empty($_GET['delete_routine'])) {
    ...
    if(is_numeric($routine_id)) {
      ...
      $success = db_delete('scl_class_routine', $where);
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div class="modal-footer">
                  ...
                  <button type="submit" class="btn btn-primary" id="edit_class_routine" name="edit_class_routine">Save Changes</button>
                </form>
              </div>
            </div>
          </div>
