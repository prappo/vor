                      ...
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              ...
                              <form class="form-horizontal" id="default" method="post">
                                  ...
                                  <input type="submit" name="add_user" class="finish btn btn-danger" value="Finish"/>
                              </form>
                          </div>
                      </section>
                  </div>
...
if(isset($_POST['add_user']))
{
  ...
  $query = mysql_query("INSERT INTO vor_admin(full_name, username, password, type, email, bio)VALUES('$name', '$user', '$pass', '$type', '$email', '$bio')");
  if($connect )
  {
